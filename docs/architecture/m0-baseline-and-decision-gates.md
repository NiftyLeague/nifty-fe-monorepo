...
- `benchmarks/results/m0-smashers-build-2026-09-07.json`: three repeat Smashers pairs with full diagnostics. All failed before route data collection because `NEXTAUTH_SECRET` was missing or shorter than 32 characters. This is an unresolved environment gate; do not compare its timings to successful production-build samples.
