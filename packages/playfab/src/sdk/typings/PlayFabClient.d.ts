...
declare namespace PlayFabClientModels {
  ...
  export interface LinkAppleAccountResult extends PlayFabModule.IPlayFabResultCommon {}
  ...
  type MatchmakeStatus =
    'Complete' | 'Waiting' | 'GameNotFound' | 'NoAvailableSlots' | 'SessionClosed'
  ...
  type TitleActivationStatus =
    'None' | 'ActivatedTitleKey' | 'PendingSteam' | 'ActivatedSteam' | 'RevokedSteam'
  ...
  type TradeStatus =
    'Invalid' | 'Opening' | 'Open' | 'Accepting' | 'Accepted' | 'Filled' | 'Cancelled'
  ...
  export interface UpdateAvatarUrlResult extends PlayFabModule.IPlayFabResultCommon {}
