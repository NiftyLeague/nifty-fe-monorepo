...
export type PlayFabResponse<
  T extends PlayFabModule.IPlayFabResultCommon = PlayFabModule.IPlayFabResultCommon,
...
export type LinkProviderResult =
  LinkGoogleResult | LinkAppleResult | LinkFacebookResult | LinkTwitchResult | null
