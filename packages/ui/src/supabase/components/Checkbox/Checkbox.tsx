...
function Group({
  ...
  return (
    <FormLayout
      ...
      size={size}
    >
      <CheckboxContext.Provider value={{ parentCallback, name, parentSize: size }}>
        {options
    ...
    <CheckboxContext.Consumer>
      {({ parentCallback, name, parentSize }) => {
        ...
        const containerClasses = [
          ...
          CheckboxStyles[`sbui-checkbox-container--${parentSize ? parentSize : size}`],
        ];
        ...
        return (
          <div className={containerClasses.join(' ')}>
            ...
            <div className={CheckboxStyles['sbui-checkbox__label-container']}>
              <label className={CheckboxStyles['sbui-checkbox__label-container__label']} htmlFor={markupId}>
                <span className={CheckboxStyles['sbui-checkbox__label-container__label__span']}>
                  {beforeLabel && (
                    <span className={CheckboxStyles['sbui-checkbox__label-text-before']}>{beforeLabel}</span>
                  )}
                  {label}
                  {afterLabel && (
                    <span className={CheckboxStyles['sbui-checkbox__label-text-after']}>{afterLabel}</span>
                  )}
                </span>

                {description && (
                  <p className={CheckboxStyles['sbui-checkbox__label-container__label__p']}>{description}</p>
                )}
              </label>
            </div>
          </div>
