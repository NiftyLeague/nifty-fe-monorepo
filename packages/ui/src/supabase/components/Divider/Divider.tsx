...
export default function Divider({
  ...
  const classes = [type === 'horizontal' ? DividerStyles['sbui-divider'] : DividerStyles['sbui-divider-vertical']];
  ...
  return (
    <div className={classes.join(' ')} role="seperator" style={style}>
      {children && <span className={DividerStyles['sbui-divider__content']}>{children}</span>}
    </div>
  );
}
