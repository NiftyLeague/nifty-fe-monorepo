...
type FontWeight =
  'inherit' | 'initial' | 'revert' | 'unset' | 'normal' | 'bold' | 'lighter' | 'bolder' | number

// Override base TypographyStyle to allow string fontSize and CSS properties
export interface TypographyStyle
  extends Omit<MuiTypographyStyle, 'fontSize' | 'fontWeight'>, CSSProperties {
...
export interface TypographyVariantsOptions extends Partial<
  Record<Variant, TypographyStyle> & FontStyleOptions
> {
  fontFamily?: string
  fontSize?: number
