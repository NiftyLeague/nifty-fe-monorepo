...
// import), so a bundler that only traces filesystem reads never includes it
// and the build crashes with `config.imx is undefined`. Importing the JSON here forces the bundler
