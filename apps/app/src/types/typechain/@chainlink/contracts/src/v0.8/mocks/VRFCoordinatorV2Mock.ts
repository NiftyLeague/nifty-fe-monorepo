...
export interface VRFCoordinatorV2Mock extends BaseContract {
  ...
  acceptSubscriptionOwnerTransfer: TypedContractMethod<[_subId: BigNumberish], [void], 'view'>;
  ...
  requestSubscriptionOwnerTransfer: TypedContractMethod<[_subId: BigNumberish, _newOwner: AddressLike], [void], 'view'>;
  ...
  ): TypedContractMethod<[_subId: BigNumberish, _newOwner: AddressLike], [void], 'view'>;
