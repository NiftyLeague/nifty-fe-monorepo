...
export interface VRFCoordinatorV2Interface extends BaseContract {
  ...
  acceptSubscriptionOwnerTransfer: TypedContractMethod<[subId: BigNumberish], [void], 'nonpayable'>;

  addConsumer: TypedContractMethod<[subId: BigNumberish, consumer: AddressLike], [void], 'nonpayable'>;

  cancelSubscription: TypedContractMethod<[subId: BigNumberish, to: AddressLike], [void], 'nonpayable'>;
  ...
  removeConsumer: TypedContractMethod<[subId: BigNumberish, consumer: AddressLike], [void], 'nonpayable'>;
