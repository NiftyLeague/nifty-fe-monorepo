...
export interface LinkTokenInterface extends BaseContract {
  ...
  decreaseApproval: TypedContractMethod<[spender: AddressLike, addedValue: BigNumberish], [boolean], 'nonpayable'>;

  increaseApproval: TypedContractMethod<[spender: AddressLike, subtractedValue: BigNumberish], [void], 'nonpayable'>;
  ...
  ): TypedContractMethod<[spender: AddressLike, subtractedValue: BigNumberish], [void], 'nonpayable'>;
