...
export interface NFTLRaffle extends BaseContract {
  ...
  chargeLINK: TypedContractMethod<[_amount: BigNumberish], [boolean], 'nonpayable'>;
  ...
  isWinnerTicketId: TypedContractMethod<[ticketId: BigNumberish], [boolean], 'view'>;
  ...
  ticketCountByUser: TypedContractMethod<[user: AddressLike], [bigint], 'view'>;
  ...
  userDeposits: TypedContractMethod<[user: AddressLike], [bigint], 'view'>;
  ...
  getFunction(nameOrSignature: 'chargeLINK'): TypedContractMethod<[_amount: BigNumberish], [boolean], 'nonpayable'>;
  ...
  getFunction(nameOrSignature: 'isWinnerTicketId'): TypedContractMethod<[ticketId: BigNumberish], [boolean], 'view'>;
  getFunction(
  ...
  getFunction(nameOrSignature: 'ticketCountByUser'): TypedContractMethod<[user: AddressLike], [bigint], 'view'>;
  getFunction(
  ...
  getEvent(
    key: 'NewUser',
  ): TypedContractEvent<NewUserEvent.InputTuple, NewUserEvent.OutputTuple, NewUserEvent.OutputObject>;
  getEvent(
  ...
  filters: {
    ...
    >;
    NewUser: TypedContractEvent<NewUserEvent.InputTuple, NewUserEvent.OutputTuple, NewUserEvent.OutputObject>;
