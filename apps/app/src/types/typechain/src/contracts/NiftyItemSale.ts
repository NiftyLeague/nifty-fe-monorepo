...
export namespace NFTLWitdrawEvent {
  export type InputTuple = [
    by: AddressLike,
...
export interface NiftyItemSale extends BaseContract {
  ...
  itemLimitPerAdress: TypedContractMethod<[arg0: BigNumberish], [bigint], 'view'>;
  ...
  getFunction(
    ...
    'nonpayable'
  >;
  getFunction(nameOrSignature: 'itemLimitPerAdress'): TypedContractMethod<[arg0: BigNumberish], [bigint], 'view'>;
  getFunction(nameOrSignature: 'itemMaxCounts'): TypedContractMethod<[arg0: BigNumberish], [bigint], 'view'>;
  getFunction(nameOrSignature: 'itemPrices'): TypedContractMethod<[arg0: BigNumberish], [bigint], 'view'>;
  ...
  getEvent(
    key: 'NFTLWitdraw',
  ): TypedContractEvent<NFTLWitdrawEvent.InputTuple, NFTLWitdrawEvent.OutputTuple, NFTLWitdrawEvent.OutputObject>;
  getEvent(
  ...
  filters: {
    ...
    >;
    NFTLWitdraw: TypedContractEvent<
      NFTLWitdrawEvent.InputTuple,
      NFTLWitdrawEvent.OutputTuple,
      NFTLWitdrawEvent.OutputObject
    >;
