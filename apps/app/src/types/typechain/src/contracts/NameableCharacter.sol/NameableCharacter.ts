...
export interface NameableCharacterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'NAME_CHANGE_PRICE'
      | 'approve'
...
export interface NameableCharacter extends BaseContract {
  connect(runner?: ContractRunner | null): NameableCharacter;
