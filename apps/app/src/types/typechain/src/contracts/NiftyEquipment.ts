...
export interface NiftyEquipmentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DEFAULT_ADMIN_ROLE'
      | 'MINTER_ROLE'
...
export interface NiftyEquipment extends BaseContract {
  connect(runner?: ContractRunner | null): NiftyEquipment;
  waitForDeployment(): Promise<this>;

  interface: NiftyEquipmentInterface;
