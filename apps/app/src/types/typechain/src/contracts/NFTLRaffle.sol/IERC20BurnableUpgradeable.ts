...
export interface IERC20BurnableUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature: 'allowance' | 'approve' | 'balanceOf' | 'burnFrom' | 'totalSupply' | 'transfer' | 'transferFrom',
  ): FunctionFragment;
...
export interface IERC20BurnableUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): IERC20BurnableUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: IERC20BurnableUpgradeableInterface;
