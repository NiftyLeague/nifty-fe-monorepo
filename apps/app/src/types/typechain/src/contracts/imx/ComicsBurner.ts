...
export interface ComicsBurnerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'burnComics'
      | 'burnComicsForWithPermit'
      | 'burnComicsWithPermit'
      | 'initialize'
      | 'marketplace'
      | 'owner'
      | 'pause'
  ...
  encodeFunctionData(
    functionFragment: 'burnComicsForWithPermit',
    values: [AddressLike, BigNumberish[], BigNumberish[], BigNumberish, BytesLike],
  ): string;
  encodeFunctionData(
    functionFragment: 'burnComicsWithPermit',
  ...
  decodeFunctionResult(functionFragment: 'burnComicsForWithPermit', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'burnComicsWithPermit', data: BytesLike): Result;
...
export interface ComicsBurner extends BaseContract {
  connect(runner?: ContractRunner | null): ComicsBurner;
  waitForDeployment(): Promise<this>;

  interface: ComicsBurnerInterface;
  ...
  burnComics: TypedContractMethod<[comicIds: BigNumberish[], comicValues: BigNumberish[]], [void], 'nonpayable'>;

  burnComicsForWithPermit: TypedContractMethod<
    [owner: AddressLike, comicIds: BigNumberish[], comicValues: BigNumberish[], deadline: BigNumberish, sig: BytesLike],
    [void],
    'nonpayable'
  >;

  burnComicsWithPermit: TypedContractMethod<
    [comicIds: BigNumberish[], comicValues: BigNumberish[], deadline: BigNumberish, sig: BytesLike],
    [void],
    'nonpayable'
  >;

  initialize: TypedContractMethod<[marketplace_: AddressLike], [void], 'nonpayable'>;
  ...
  ): TypedContractMethod<[comicIds: BigNumberish[], comicValues: BigNumberish[]], [void], 'nonpayable'>;
  getFunction(
    nameOrSignature: 'burnComicsForWithPermit',
  ): TypedContractMethod<
    [owner: AddressLike, comicIds: BigNumberish[], comicValues: BigNumberish[], deadline: BigNumberish, sig: BytesLike],
    [void],
    'nonpayable'
  >;
  getFunction(
    nameOrSignature: 'burnComicsWithPermit',
  ): TypedContractMethod<
    [comicIds: BigNumberish[], comicValues: BigNumberish[], deadline: BigNumberish, sig: BytesLike],
    [void],
    'nonpayable'
  >;
  getFunction(nameOrSignature: 'initialize'): TypedContractMethod<[marketplace_: AddressLike], [void], 'nonpayable'>;
