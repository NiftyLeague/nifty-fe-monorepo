...
export interface ComicsBurner extends BaseContract {
  ...
  burnComics: TypedContractMethod<
    [comicIds: BigNumberish[], comicValues: BigNumberish[]],
    [void],
    'nonpayable'
  >
  ...
  burnComicsForWithPermit: TypedContractMethod<
    [
      owner: AddressLike,
      comicIds: BigNumberish[],
      comicValues: BigNumberish[],
  ...
  ): TypedContractMethod<[marketplace_: AddressLike], [void], 'nonpayable'>
