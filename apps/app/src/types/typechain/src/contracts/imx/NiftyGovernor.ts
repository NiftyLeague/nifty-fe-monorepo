...
export interface NiftyGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'BALLOT_TYPEHASH'
      | 'CLOCK_MODE'
...
export interface NiftyGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): NiftyGovernor;
  waitForDeployment(): Promise<this>;

  interface: NiftyGovernorInterface;
  ...
  castVote: TypedContractMethod<[proposalId: BigNumberish, support: BigNumberish], [bigint], 'nonpayable'>;
  ...
  hasVoted: TypedContractMethod<[proposalId: BigNumberish, account: AddressLike], [boolean], 'view'>;
  ...
  relay: TypedContractMethod<[target: AddressLike, value: BigNumberish, data: BytesLike], [void], 'payable'>;

  setProposalThreshold: TypedContractMethod<[newProposalThreshold: BigNumberish], [void], 'nonpayable'>;

  setVotingDelay: TypedContractMethod<[newVotingDelay: BigNumberish], [void], 'nonpayable'>;

  setVotingPeriod: TypedContractMethod<[newVotingPeriod: BigNumberish], [void], 'nonpayable'>;
  ...
  updateQuorumNumerator: TypedContractMethod<[newQuorumNumerator: BigNumberish], [void], 'nonpayable'>;
  ...
  ): TypedContractMethod<[proposalId: BigNumberish, support: BigNumberish, reason: string], [bigint], 'nonpayable'>;
  getFunction(
  ...
  ): TypedContractMethod<[account: AddressLike, timepoint: BigNumberish, params: BytesLike], [bigint], 'view'>;
  getFunction(
  ...
  ): TypedContractMethod<[target: AddressLike, value: BigNumberish, data: BytesLike], [void], 'payable'>;
  getFunction(
    nameOrSignature: 'setProposalThreshold',
  ): TypedContractMethod<[newProposalThreshold: BigNumberish], [void], 'nonpayable'>;
  getFunction(
  ...
  getEvent(
    key: 'VoteCast',
  ): TypedContractEvent<VoteCastEvent.InputTuple, VoteCastEvent.OutputTuple, VoteCastEvent.OutputObject>;
  getEvent(
