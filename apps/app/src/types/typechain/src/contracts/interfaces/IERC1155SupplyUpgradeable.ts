...
export interface IERC1155SupplyUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'balanceOf'
      | 'balanceOfBatch'
...
export interface IERC1155SupplyUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): IERC1155SupplyUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: IERC1155SupplyUpgradeableInterface;
