...
export interface INiftyMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DOMAIN_SEPARATOR'
      | 'balanceOf'
...
export interface INiftyMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): INiftyMarketplace;
  waitForDeployment(): Promise<this>;

  interface: INiftyMarketplaceInterface;
