...
export interface IERC20PresetMinterPauserUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature: 'allowance' | 'approve' | 'balanceOf' | 'burn' | 'totalSupply' | 'transfer' | 'transferFrom',
  ): FunctionFragment;
