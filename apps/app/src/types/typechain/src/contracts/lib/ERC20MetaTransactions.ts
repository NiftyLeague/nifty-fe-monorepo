...
export interface ERC20MetaTransactionsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DOMAIN_SEPARATOR'
      | 'allowance'
  ...
  getEvent(
    nameOrSignatureOrTopic:
      'Approval' | 'EIP712DomainChanged' | 'MetaTransactionExecuted' | 'Transfer'
  ): EventFragment
...
export interface ERC20MetaTransactions extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20MetaTransactions
  waitForDeployment(): Promise<this>

  interface: ERC20MetaTransactionsInterface
  ...
  getFunction(
    nameOrSignature: 'invalidateNext'
  ): TypedContractMethod<[offset: BigNumberish], [void], 'nonpayable'>
