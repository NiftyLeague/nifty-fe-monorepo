...
export interface NFTLToken extends BaseContract {
  ...
  getFunction(
    nameOrSignature: 'accumulated'
  ): TypedContractMethod<[tokenIndex: BigNumberish], [bigint], 'view'>
  getFunction(
  ...
  ): TypedContractMethod<[tokenIndices: BigNumberish[]], [bigint], 'nonpayable'>
