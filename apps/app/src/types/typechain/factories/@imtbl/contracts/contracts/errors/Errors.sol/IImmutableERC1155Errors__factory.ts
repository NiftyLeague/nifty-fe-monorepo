...
export class IImmutableERC1155Errors__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): IImmutableERC1155Errors {
    return new Contract(address, _abi, runner) as unknown as IImmutableERC1155Errors;
  }
}
