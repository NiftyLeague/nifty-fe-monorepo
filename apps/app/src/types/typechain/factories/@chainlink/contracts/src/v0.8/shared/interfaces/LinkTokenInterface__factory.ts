...
const _abi = [
  ...
  },
  {
    inputs: [],
    name: 'decimals',
    outputs: [{ internalType: 'uint8', name: 'decimalPlaces', type: 'uint8' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'symbol',
    outputs: [{ internalType: 'string', name: 'tokenSymbol', type: 'string' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'totalSupply',
    outputs: [{ internalType: 'uint256', name: 'totalTokensIssued', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
