  ...
  return (
    <Container>
      ...
      <p>
        ...
        . If You disagree with any part of these Terms and Conditions, Disclaimer, or Privacy Policy then You may not
      ...
      <p>
        ...
        the warnings and expectations outlined in our{' '}
        <a target="_blank" rel="noopener noreferrer" href="https://niftyleague.com/disclaimer">
          Disclaimer
        </a>
        .
      ...
      <p>
        ...
        restricted parties. Please read our{' '}
        <a target="_blank" rel="noopener noreferrer" href="https://niftyleague.com/disclaimer">
          Disclaimer
        </a>{' '}
        for more details.
      ...
      <p>
        ...
        describes the ways we collect, use, store and disclose Your personal information, and is hereby incorporated by
        this reference into these Terms. You agree to the collection, use, storage, and disclosure of Your data in
