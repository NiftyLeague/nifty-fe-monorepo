...
const TermsOfServiceContent = () => {
  return (
    <div className="container">
      ...
      <p>
        In addition, each DEGEN NFT-Token accumulates a utility and governance token
        (&quot;NFTL&quot;). The NFTL token cannot be purchased, but it can be freely accumulated by
        holding the DEGEN NFT-Token along with contributing to the community. The Company does not
        provide or intend to provide a secondary market place for our NFT-Tokens or NFTL. NFTL does
        not constitute any ownership of the Company nor do we guarantee any value to the NFTL token
        in and of itself outside of the Nifty DAO, nor do we guarantee NFTL will be used for any
        platform-wide expenses outside of renaming characters. After the sale of an NFT-Token to
        You, the ownership of the NFT-Token, and to the connected Art, is transferred from the Smart
      ...
      <p>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://niftyleague.com/disclaimer">
          Disclaimer
        </a>{' '}
        and{' '}
        <a target="_blank" rel="noopener noreferrer" href="https://niftyleague.com/privacy-policy">
          Privacy Policy
        </a>
        . If You disagree with any part of these Terms and Conditions, Disclaimer, or Privacy Policy
      ...
      <p>
        ...
        (collectively, &quot;User Contributions&quot;) for our current and future business purposes,
        including to provide, promote, and improve the Site and the App. This includes any digital
        file, art, or other material linked to or associated with any NFTs or other crypto assets
        that are displayed on the Site or the App.
      </p>
      <p>
      ...
      <ol type="A">
        ...
        <li>
          Ethereum requires the payment of a transaction fee (&quot;Gas Fee&quot;) for every
        ...
        <li>
          ...
          pay any and all sales, use, value-added and other taxes, duties, and assessments
          (&quot;Taxes&quot;) associated with Your use of the App (including, without limitation,
          any Taxes that may become payable as the result of Your ownership of a Nifty League
          NFT-Token or NFTL. Except for income and net-wealth taxes levied on The Company, You: (i)
          will pay or reimburse us for all national, federal, state, local or other taxes and
      ...
      <p>
        ...
        describes the ways we collect, use, store and disclose Your personal information, and is
        hereby incorporated by this reference into these Terms. You agree to the collection, use,
        storage, and disclosure of Your data in accordance with our Privacy Policy.
      </p>
      ...
      <p>
        ...
        <a target="_blank" rel="noopener noreferrer" href="mailto:team@niftyleague.com">
