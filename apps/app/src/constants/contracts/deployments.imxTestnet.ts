      ...
      abi: [
        {
          inputs: [
            ...
            { internalType: 'contract TimelockController', name: 'timelock_', type: 'address' },
            { internalType: 'uint256', name: 'initialVotingDelay_', type: 'uint256' },
            { internalType: 'uint256', name: 'initialVotingPeriod_', type: 'uint256' },
            { internalType: 'uint256', name: 'initialProposalThreshold_', type: 'uint256' },
            { internalType: 'uint256', name: 'initialQuorumNumerator_', type: 'uint256' },
          ],
          stateMutability: 'nonpayable',
          type: 'constructor',
        },
