...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: 'https://app.niftyleague/dashboard',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.8,
    },
    ...
    {
      url: 'https://app.niftyleague/degens',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.8,
    },
    {
      url: 'https://app.niftyleague/games',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.8,
    },
    ...
    {
      url: 'https://app.niftyleague/leaderboards',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.8,
    },
    {
      url: 'https://app.niftyleague/mint-o-matic',
      lastModified: new Date(),
      changeFrequency: 'yearly',
      priority: 0.8,
    },
