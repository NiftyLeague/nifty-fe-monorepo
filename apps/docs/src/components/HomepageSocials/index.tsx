...
export default function HomepageSocials() {
  return (
    <Section>
      <RowThree>
        <a style={{ textDecoration: 'none' }} href="https://discord.gg/niftyleague">
          <CenterCard>
            <StyledIcon>
        ...
        <a style={{ textDecoration: 'none' }} href="https://twitter.com/NiftyLeague">
          <CenterCard>
            <StyledIcon>
        ...
        <a style={{ textDecoration: 'none' }} href="https://github.com/NiftyLeague">
          <CenterCard>
            <StyledIcon>
