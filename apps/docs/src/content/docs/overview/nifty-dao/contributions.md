...
If you read through the [DAO overview](/docs/overview/nifty-dao/about) and are interested in getting involved, please reach out to our team on [Discord](https://discord.gg/niftyleague) so we can provide appropriate permissions to our codebase.
...
Please note we have a [code of conduct](/docs/overview/nifty-dao/conduct), please follow it in all your interactions with the project.
