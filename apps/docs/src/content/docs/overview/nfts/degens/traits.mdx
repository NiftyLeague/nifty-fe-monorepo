...
<div style={{ maxWidth: '650px', margin: 'auto' }}>![](/docs/img/mint-o-matic/creation.webp)</div>
<br />
...
While [background types](/docs/overview/nfts/degens/backgrounds) may come with special benefits, other character traits are strictly cosmetic. It's most important to pick a DEGEN you like!
