...
<picture>
  <source
    ...
    type="image/webp"
    srcSet="https://cdn.niftyleague.com/media/img/mint-o-matic/degen-mint.webp"
  />
  <img
    src="/docshttps://cdn.niftyleague.com/media/img/mint-o-matic/degen-mint-poster.webp"
...
<DeferredYouTubeEmbed
  ...
  className="pixelated"
  style={{ display: 'block', width: '100%', height: '380px', borderRadius: '25px' }}
/>
