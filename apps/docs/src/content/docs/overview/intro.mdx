...
import bannerLight from '../../../../../../assets/img/backgrounds/banner-light.webp'
import bannerDark from '../../../../../../assets/img/backgrounds/banner-dark.webp'
...
<div style={{ margin: 'auto' }}>![](/docs/img/mint-o-matic/creation.webp)</div>
...
<div style={{ maxWidth: '400px', margin: 'auto' }}>![](/docs/img/events/ape-speech.webp)</div>
