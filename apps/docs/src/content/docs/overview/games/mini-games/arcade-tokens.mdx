...
<video
  ...
  playsInline
  preload="metadata"
  src="/docshttps://cdn.niftyleague.com/media/video/arcade-token.mp4"
  style={{ display: 'block', width: '100%', aspectRatio: '16 / 9', height: 'auto' }}
></video>

---

Arcade Tokens were initially intoduced back in 2022 as a way to play for rewards in our first on-chain mini-games, [WEN Game](/docs/overview/games/mini-games/wen-game) & [Crypto Winter](/docs/overview/games/mini-games/crypto-winter). This system is since **deprecated**, however, Mini Games & Arcade Tokens are being brought back to life in all our mobile game titles, including [NiftyWorld](/docs/overview/games/niftyworld).
...
If you wish to test out our old system, Arcade Tokens can still be used in our ecosystem to play [WEN Game](/docs/overview/games/mini-games/wen-game).
...
Purchasing Arcade Tokens in the Dashboard can be done on (1) [the Games page](https://app.niftyleague.com/games) by clicking the **Buy Arcade Tokens** button in the WEN Game card, (2) [the Overview page](https://app.niftyleague.com/dashboard), or by clicking the **Buy Tokens** button in the Arcade Token Balance box.
