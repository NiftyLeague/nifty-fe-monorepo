...
![](/docs/img/games/nifty-tennis.webp)
...
![](/docs/img/sketches/tennis-sketch.webp)

## Nifty Kart

<div style={{ maxWidth: '400px', margin: 'auto' }}>![](/docs/img/roadmap/niftykart_v01.webp)</div>
...
![](/docs/img/sketches/nifty-racers-sketch.webp)

## Other Ideas...?

<div style={{ maxWidth: '400px', margin: 'auto' }}>![](/docs/img/games/breakout.webp)</div>

![](/docs/img/sketches/smash-sketch.webp)

![](/docs/img/sketches/games-sketch.webp)
