...
<div style={{ maxWidth: '450px', margin: 'auto' }}>![](/docs/img/roadmap/niftyroyale_v01.webp)</div>
...
<div style={{ maxWidth: '640px', marginRight: 'auto' }}>
  ![](/docs/img/niftyworld/nakedbeach_01.webp)
</div>
<div style={{ maxWidth: '640px', marginLeft: 'auto' }}>
  ![](/docs/img/niftyworld/beachcity_01.webp)
</div>
<div style={{ maxWidth: '640px', marginRight: 'auto' }}>
  ![](/docs/img/niftyworld/beachcity_04.webp)
</div>
...
<video
  ...
  playsInline
  preload="metadata"
  src="/docs/video/nakedbeachflyby.mp4"
