...
<div style={{ maxWidth: '500px', margin: 'auto' }}>
  ![](/docs/img/logos/smashers/app_wordmark_logo_small.webp)
</div>
...
<DeferredYouTubeEmbed
  ...
  style={{ display: 'block', width: '100%', aspectRatio: '908 / 510', height: 'auto' }}
/>
...
<video
  ...
  playsInline
  preload="metadata"
  src="/docshttps://cdn.niftyleague.com/media/video/lobby.mp4"
  style={{ display: 'block', width: '100%', aspectRatio: '908 / 510', height: 'auto' }}
></video>
