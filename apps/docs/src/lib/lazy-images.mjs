 ...
 *
 * The previous site lazy-loaded every content image below the fold. Images that
 * already declare `loading` or `fetchpriority` opt out, so pages that
 * intentionally prioritise a hero keep eager loading.
 *
