...
Nifty Royale takes place in our Beach City & Naked Beach regions of [NiftyWorld](/overview/games/niftyworld).
...
<ViewportVideo deferLoad playsInline src={VideoURL} style={{ display: 'block', width: '100%', height: 350 }} />
<br />
