          ...
          <div className={styles.description}>
            ...
            <AnimatedWrapper>
              <p className="animated-header-text animated-header-text-start transition-delay-small">
                Nifty League&apos;s mission is to establish a game studio of unparalleled quality and player experience
                to inspire other indie game developers to build a decentralized future with us. We are backed by top VCs
