...
const PrivacyPolicy: NextPage = () => (
  <Container sx={{ p: { xs: 2, md: 4 }, pt: { xs: 15, md: 20 } }}>
    <div className="mb-3 mb-md-5">
      <AnimatedWrapper>
        <h1 className="text-center transition-fade-slow transition-fade-start delay-lite">PRIVACY POLICY</h1>
      </AnimatedWrapper>
    </div>
    <AnimatedWrapper>
    ...
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">Types of Data Collected:</p>
    </AnimatedWrapper>
    <ol>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">Personal Data</p>
          </AnimatedWrapper>
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">
      ...
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">Usage Data</p>
          </AnimatedWrapper>
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">
          ...
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">
              ...
              your mobile device&apos;s operating system, the type of mobile Internet browser you use, unique device
      ...
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">Tracking Cookies Data</p>
          </AnimatedWrapper>
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">
          ...
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">Examples of Cookies we use:</p>
          </AnimatedWrapper>
          <AnimatedWrapper>
            <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Use of Data</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Transfer of Data</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Disclosure of Data</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Security of Data</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Service Providers</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Links to Other Sites</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Children&apos;s Privacy</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
