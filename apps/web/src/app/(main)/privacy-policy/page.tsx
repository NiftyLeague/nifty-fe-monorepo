...
const PrivacyPolicy: NextPage = () => (
  <Container sx={{ p: { xs: 2, md: 4 }, pt: { xs: 15, md: 20 } }}>
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 animated-fade-slow animated-fade-start transition-delay-medium">Transfer of Data</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="animated-fade-slow animated-fade-start transition-delay-medium">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 animated-fade-slow animated-fade-start transition-delay-medium">Security of Data</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="animated-fade-slow animated-fade-start transition-delay-medium">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 animated-fade-slow animated-fade-start transition-delay-medium">Service Providers</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="animated-fade-slow animated-fade-start transition-delay-medium">
