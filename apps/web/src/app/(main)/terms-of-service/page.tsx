...
const ToS: NextPage = () => (
  <div className="container pt-30 mb-20">
    ...
    <Definitions />
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Acknowledgement</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">User Representations</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Placing Orders for Goods</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <ul>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-lite">Goods availability</li>
      </AnimatedWrapper>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-lite">Errors in Your Order</li>
      </AnimatedWrapper>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-lite">Technical problems</li>
      </AnimatedWrapper>
    </ul>
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-lite">Your Order Cancellation Rights</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Links to Other Websites</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Termination</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Limitation of Liability</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Assumption of Risk</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Disclaimer</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Governing Law</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Disputes Resolution</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-lite">Informal Negotiations</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Severability and Waiver</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Translation Interpretation</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Indemnification</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Privacy Policy</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Contact Us</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
