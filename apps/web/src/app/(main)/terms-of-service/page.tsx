...
const ToS: NextPage = () => (
  <Container sx={{ p: { xs: 2, md: 4 }, pt: { xs: 15, md: 20 } }}>
    <div className="mb-3 mb-md-5">
      <AnimatedWrapper>
        <h1 className="text-center transition-fade-slow transition-fade-start delay-lite">TERMS AND CONDITIONS</h1>
      </AnimatedWrapper>
    </div>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <Definitions />
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Acknowledgement</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">
    ...
    <ol>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">User Representations</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Placing Orders for Goods</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Your Information</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Order Cancellation</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <ul>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">Goods availability</li>
      </AnimatedWrapper>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">Errors in Your Order</li>
      </AnimatedWrapper>
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">Technical problems</li>
      </AnimatedWrapper>
    </ul>
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Your Order Cancellation Rights</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Prices Policy</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Payments</h6>
    </AnimatedWrapper>
    <ol type="A">
      <AnimatedWrapper>
        <li className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Links to Other Websites</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Termination</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Limitation of Liability</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Assumption of Risk</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Abuse</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Disclaimer</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Governing Law</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Disputes Resolution</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Informal Negotiations</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Binding Arbitration</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Severability and Waiver</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Severability</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Waiver</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Indemnification</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Privacy Policy</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-normal">Contact Us</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
