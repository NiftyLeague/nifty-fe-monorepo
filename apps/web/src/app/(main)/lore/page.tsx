...
const Lore: NextPage = () => {
  return (
    <div className="pt-20 overflow-hidden">
      <AnimatedWrapper>
        <h1 className="text-center transition-fade-slow transition-fade-start delay-lite mb-3">
          LORE
        </h1>
      </AnimatedWrapper>
          ...
          <div className={styles.inner}>
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                Satoshi Nakamoto was a quiet genius. Having lived in Japan as an inventor, one day
                his prodigious tinkering led to the creation of a little project known as Bitcoin.
                After changing the world as we know it and paving the way for endless successors,
                imitators, and meme coins, he retired to a life of equal parts solitude and secrecy.
              </p>
            </AnimatedWrapper>
            <br />
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                ...
                greatest minds across the multiverse to aid him in saving his world, and that
                journey had brought him to Satoshi.
              </p>
            </AnimatedWrapper>
            <br />
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                Satoshi got into his Space Bubble and warp-jumped to NiftyWorld. Once there he
                learned that 6 tribes that inhabited NiftyWorld (Frogs, Cats, Doges, Humans, Aliens
            ...
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                ...
                games. He formalized anyone&apos;s entrance into the Nifty League by minting them
                with unique attributes in his novel Mint-O-Matic machine, and named those enrollees
            ...
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                ...
                the occasional bonk on the head with a baseball bat. Any Degen with a special
                Citadel Key would be granted access to this idyllic area, and would be the Degens
                Satoshi considered assets to the Nifty League community, and NiftyWorld as a whole.
              </p>
            </AnimatedWrapper>
            <br />
            <AnimatedWrapper immediate>
            ...
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                But Satoshi&apos;s astronomic rise as the savior of NiftyWorld perhaps went a step
                too far, as Satoshi&apos;s tinkering with this parallel world has seen an ancient
                evil once feared in NiftyWorld awaken.
              </p>
            </AnimatedWrapper>
            <br />
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                ...
                experiment by Satoshi. Along with his grunts in the fiery Mt. Gawx, and his second
                in command Pengweevil who rules the Northern Ice Cap, RugMan seeks to reclaim the
                planet he once ruled over with an iron fist and diamond hands.
              </p>
            </AnimatedWrapper>
            <AnimatedWrapper immediate>
              <p className="transition-fade-slow transition-fade-start delay-lite">
                Feeling responsible for bringing the now peaceful world into danger once more,
                Satoshi has vowed to put an end to RugMan once and for all, and with his faithful
                army of Degens under his control, the battle for NiftyWorld has just begun.
              </p>
            </AnimatedWrapper>
          </div>
        </div>
        <div className={styles.satoshiContainer}>
          <AnimatedWrapper>
            <div
              className={cn(
                styles.satoshi,
                'relative flex-1 transition-fade-slow transition-fade-start delay-long'
              )}
            >
              <Image
                alt="Satoshi"
