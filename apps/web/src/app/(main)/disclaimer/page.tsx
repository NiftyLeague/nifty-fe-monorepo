...
const Disclaimer: NextPage = () => (
  <div className="container pt-30 mb-20">
    <div className="mb-3 mb-md-5">
      <AnimatedWrapper>
        <h1 className="text-center transition-fade-slow transition-fade-start delay-lite">DISCLAIMER</h1>
      </AnimatedWrapper>
    </div>
    <AnimatedWrapper>
    ...
    <Definitions />
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Rights and Conditions</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">Warranties and Limitations</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
    ...
    <AnimatedWrapper>
      <h5 className="my-3 my-md-5 transition-fade-slow transition-fade-start delay-lite">“AS IS” and “AS AVAILABLE”</h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-lite">
