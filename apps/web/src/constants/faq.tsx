...
export const FAQS = [
  ...
  },
  {
    ...
    answer: (
      <>
        NFTL is our platform-wide governance and utility token. The token was distributed freely to
        DEGEN NFT holders and Nifty Smashers players through special events. The team has never, nor
        will ever, sell NFTL to the public. It is available for trading on decentralized exchanges
        such as QuickSwap (Immutable zkEVM) & Uniswap (Ethereum).
        <br />
        <br />
        ...
        <ol>
          ...
          <li>
            Platform fees: Renaming DEGENs, DEGEN rentals (deprecated), Mini-Games (deprecated), etc
          </li>
        </ol>
        Read our{' '}
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Battle it out amongst the community and get in as many bat bonks on your friends as you can!
        Nifty Smashers takes inspiration from the classic Super Smash Bros game where the objective
        is to knock your opponents off the map to score points.
        <br />
        <br />
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        are free-to-play. If you own a DEGEN or hold a partner NFT from CyberKongz, Forgotten Runes,
        or Degods your avatars will be available once you create an account and connect your wallet.
      </>
    ),
  },
]
