...
export default function HomeSponsorsSection() {
  return (
    <section class="home-static-section section w-screen relative text-center">
      <h2 class="my-3 lg:my-5 section-heading transition-vertical-fade">PROUDLY BACKED BY</h2>
      <Sponsors />
      <ThemeButtonGroup
