...
const HOME_SECTION_LOADERS = [
  () => import('@/components/HomeSections/HomeV3Characters'),
  () => import('@/components/HomeSections/HomeV3Games'),
  () => import('@/components/HomeSections/HomeV3Studio'),
  () => import('@/components/HomeSections/HomeV3Community'),
