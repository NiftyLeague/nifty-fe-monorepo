...
const Definitions = (): React.ReactNode => (
  <>
    <AnimatedWrapper>
      <h5 className="my-3 md:my-5 transition-fade-slow transition-fade-start delay-normal">
        Interpretation and Definitions
      </h5>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Interpretation</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
    ...
    <AnimatedWrapper>
      <h6 className="transition-fade-slow transition-fade-start delay-normal">Definitions</h6>
    </AnimatedWrapper>
    <AnimatedWrapper>
      <p className="transition-fade-slow transition-fade-start delay-normal">
